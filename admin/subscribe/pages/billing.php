...
$plans_query = $pdo->prepare("SELECT * FROM subscription_plans WHERE is_active = 1 ORDER BY price ASC");
$plans_query->execute();
$subscription_plans = $plans_query->fetchAll(PDO::FETCH_ASSOC);

// Convertir a array asociativo por plan_type para fácil acceso
$plans_by_type = [];
foreach ($subscription_plans as $plan) {
    $plans_by_type[$plan['plan_type']] = $plan;
}
?>
<!DOCTYPE html>
                ...
                <div class="plans-grid">
                    ...
                    <div class="plan-card" data-plan="free" onclick="selectPlan('free')">
                        <div class="plan-header">
                            ...
                            <div class="plan-price">$<?php echo number_format($plans_by_type['free']['price'] ?? 0, 0); ?><span>/<?php echo t('mes', 'month'); ?></span></div>
                        </div>
                    ...
                    <div class="plan-card premium" data-plan="premium" onclick="selectPlan('premium')">
                        ...
                        <div class="plan-header">
                            <h3>Premium</h3>
                            <div class="plan-price">$<?php echo number_format($plans_by_type['premium']['price'] ?? 0, 2); ?><span>/<?php echo t('mes', 'month'); ?></span></div>
                        </div>
                        <div class="plan-features">
                            <ul>
                    ...
                    <div class="plan-card enterprise" data-plan="enterprise" onclick="selectPlan('enterprise')">
                        <div class="plan-header">
                            ...
                            <div class="plan-price">$<?php echo number_format($plans_by_type['enterprise']['price'] ?? 0, 2); ?><span>/<?php echo t('mes', 'month'); ?></span></div>
                        </div>
                        <div class="plan-features">
                            <ul>
                                <li><i class="fas fa-check"></i> <?php echo t('Importaciones ilimitadas', 'Unlimited imports'); ?></li>
