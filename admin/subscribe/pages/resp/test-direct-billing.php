<?php
/**
 * Prueba directa de creación de ciclo de facturación (sin cURL)
 */
...
echo "<h1>Prueba Directa de Billing Cycles</h1>";
...
echo "<button type='submit' style='background: #007bff; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;'>Crear Ciclo Pendiente</button>";
echo "</form>";
