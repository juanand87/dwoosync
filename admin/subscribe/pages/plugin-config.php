...
<head>
    ...
    <style>
        ...
        /* Estilos para botón copiar licencia */
        .copy-license-btn {
            background: #3b82f6;
            color: white;
            border: none;
...
<body>
    ...
    <!-- JavaScript para el dropdown de idioma y menú de usuario (siempre disponible) -->
    <script>
            ...
            <div class="license-info">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    <div>
                        ...
                        <code id="license-key-display" style="background: rgba(255,255,255,0.2); padding: 0.5rem; border-radius: 4px; font-size: 1.1rem;">
                            <?php echo htmlspecialchars($licenseKey); ?>
                        </code>
                        <br>
                        <button onclick="copyLicenseKey()" id="copy-license-btn" style="margin-top: 0.5rem; padding: 0.5rem 1rem; background: #3b82f6; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 0.9rem; transition: background-color 0.3s ease;">
                            <i class="fas fa-copy"></i> <?php echo t('Copiar Licencia', 'Copy License'); ?>
                        </button>
                    </div>
                    <div>
        ...
        function copyLicenseKey() {
            ...
            if (navigator.clipboard && window.isSecureContext) {
                navigator.clipboard.writeText(licenseKey).then(function() {
                    showCopyFeedback('<?php echo t('¡Licencia copiada!', 'License copied!'); ?>');
                }).catch(function(err) {
        ...
        function fallbackCopyTextToClipboard(text) {
            ...
            try {
                ...
                if (successful) {
                    ...
                    showCopyFeedback('<?php echo t('Error al copiar', 'Error copying'); ?>');
                }
            } catch (err) {
