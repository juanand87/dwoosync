                    ...
                    <div class="plan-card" data-plan="free" onclick="selectPlan('free')">
                        ...
                        <div class="plan-features">
                            <ul>
                                ...
                                <li><i class="fas fa-check"></i> <?php echo t('Soporte por email', 'Email support'); ?></li>
                                <li><i class="fas fa-check"></i> <?php echo t('Actualizaciones básicas', 'Basic updates'); ?></li>
                            </ul>
                    </div>
                    ...
                    <div class="plan-card premium" data-plan="premium" onclick="selectPlan('premium')">
                        ...
                        <div class="plan-features">
                            <ul>
                                ...
                                <li><i class="fas fa-check"></i> <?php echo t('Todas las actualizaciones', 'All updates'); ?></li>
                                <li><i class="fas fa-check"></i> <?php echo t('Estadísticas avanzadas', 'Advanced statistics'); ?></li>
